...
export function WorkHistory() {
  return (
    <section className="z-[8] -mt-6 rounded-b-3xl bg-background bg-white pb-12 pt-16 text-center">
      <Typography variant="heading">Work history</Typography>
      <div className="relative overflow-y-hidden py-4">
        <div className="relative mx-16 flex w-max items-center gap-x-12">
