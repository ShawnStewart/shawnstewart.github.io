  ...
  return (
    <Link
      className={cn(
        buttonVariants({
          className:
            'group relative overflow-hidden rounded-full bg-linear-to-r from-blue-600 to-purple-600 text-white shadow-lg transition-all duration-300 hover:from-blue-700 hover:to-purple-700 hover:shadow-xl',
        }),
      )}
      to={`mailto:${email}`}
    >
      <span className="relative z-10 flex items-center">{children}</span>
      <div className="absolute inset-0 -translate-x-full rounded-full bg-linear-to-r from-purple-600 to-blue-600 transition-transform duration-300 group-hover:translate-x-0" />
    </Link>
  );
}
...
function HeroSection() {
  return (
    <section className="relative min-h-[calc(100vh-3.75rem)] overflow-hidden bg-linear-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      {/* Background elements */}
      <div className="absolute inset-0">
        <div className="bg-grid-pattern absolute inset-0 opacity-5" />
        <div className="absolute -top-40 -right-40 h-80 w-80 rounded-full bg-blue-500/20 blur-3xl dark:bg-blue-500/10" />
        <div className="absolute -bottom-40 -left-40 h-80 w-80 rounded-full bg-purple-500/20 blur-3xl dark:bg-purple-500/10" />
      </div>

      <div className="relative container flex min-h-[calc(100vh-3.75rem)] flex-col items-center justify-center text-center">
        <motion.div
          animate="animate"
          className="space-y-6"
          initial="initial"
        ...
        >
          <motion.div variants={fadeInUp}>
            <Heading className="text-6xl leading-tight font-bold text-gray-900 lg:text-6xl dark:text-white">
              <span>Hey 👋, I&apos;m</span>
              <span className="block bg-linear-to-r from-blue-400 to-purple-600 bg-clip-text text-5xl text-transparent md:text-6xl">
                Shawn Stewart
              </span>
              <motion.div
                animate={{ scale: 1 }}
              ...
              >
                <div className="mx-auto my-4 max-w-48 rounded-full border-2 border-purple-600 shadow-lg xl:max-w-80">
                  <img
                    ...
                    className="rounded-full border-4 border-blue-400 bg-linear-to-br from-blue-100 via-purple-100 to-pink-100 dark:bg-linear-to-br dark:from-gray-800 dark:via-gray-700 dark:to-gray-600"
                    src="./head.png"
                  />
                </div>
              </motion.div>
              <span className="block text-4xl text-gray-700 dark:text-gray-300">
                ...
                <span className="block bg-linear-to-r from-[#0069A7] to-[#E31837] bg-clip-text px-1 text-transparent dark:from-[#0069A7] dark:to-[#E31837]">
                  Domino&apos;s Pizza
                </span>
              </span>
            </Heading>
...
function WorkHistorySection() {
  return (
    <section className="bg-linear-to-br from-blue-50 via-purple-50 to-pink-50 py-20 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="container">
        <motion.div
        ...
        >
          ...
          <motion.div
            className="inline-flex flex-wrap items-center justify-center gap-x-8 gap-y-4 rounded-3xl bg-white/80 p-8 shadow-xl backdrop-blur-xs dark:bg-gray-50/80"
            variants={fadeInUp}
          >
